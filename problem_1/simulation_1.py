...
if __name__ == '__main__':
    ...
    encap_tbl_D = {'H1': 'RB'}    # table used to encapsulate network packets into MPLS frames
    frwd_tbl_D = {'H1': ('', 0), 'RB': ('H2', 1)}     # table used to forward AND decapsulate MPLS frames
    ...
    for i in range(5):
        priority = i%2
        host_1.udt_send('H2', 'H1', 'MESSAGE_%d_FROM_H1' % i, priority)
